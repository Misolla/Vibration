...
//   int currentButtonIncrementState = digitalRead(buttonIncrementPin);
//   // Button handling
...
//   if (currentButtonIncrementState != lastButtonIncrementState && currentButtonIncrementState == HIGH) {
//     if (settingHour) {
